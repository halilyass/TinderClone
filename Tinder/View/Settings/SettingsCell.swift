...
//  Tinder
//
//  Created by Halil YAŞ on 18.08.2022.
//
...
protocol SettingsCellDelegate: class {
    ...
    func settingsCell(_cell: SettingsCell, wantsToUpdateAgeRangeWith sender: UISlider)
}
...
class SettingsCell: UITableViewCell {
    ...
    @objc func handleAgeRangeChanged(sender : UISlider) {
        ...
        delegate?.settingsCell(_cell: self, wantsToUpdateAgeRangeWith: sender)
    }
